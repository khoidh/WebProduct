...
<div id='slide'>
    <div id="img-slide" class="sliderContainer" style='width:580px'>
        <div id="HomeSlide" class="royalSlider rsMinW">
            <a href="http://dantri.com.vn/" target='_blank'><img src="<?php echo public_url() ?>/upload/slide/31.jpg" /> </a>
            <a href="http://dantri.com.vn/" target='_blank'><img src="<?php echo public_url() ?>/upload/slide/21.jpg" /> </a>
            <a href="http://dantri.com.vn/" target='_blank'><img src="<?php echo public_url() ?>/upload/slide/11.jpg" /> </a>
        </div>
    </div>
    <div class="clear"></div>
</div>
        ...
        <div class='product_item'>
            ...
            <div class='product_img'>
                <a  href="san-pham-Tivi-JVC-500/8.html" title="Sản phẩm">
                    <img src="<?php echo public_url() ?>/upload/product/product7.jpg" alt=''/>
                </a>
            </div>
            <p class='price'>
                9,500,000 đ
        ...
        <div class='product_item'>
            ...
            <div class='product_img'>
                <a  href="san-pham-Tivi-Toshiba/7.html" title="Sản phẩm">
                    <img src="<?php echo public_url() ?>/upload/product/product6.jpg" alt=''/>
                </a>
            </div>
            <p class='price'>
                5,800,000 đ
